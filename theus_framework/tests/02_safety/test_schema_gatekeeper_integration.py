...
class TestSchemaGatekeeper(unittest.TestCase):
    ...
    async def _run_async_test(self):
        ...
        # Explicitly ensure Schema is registered (though init should do it)
        engine._core.set_schema(BankSystem)
        ...
        self.assertIsInstance(current_data, BankAccount, "State should remain a Pydantic Model")
